...
class EventDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.event.observe(viewLifecycleOwner) { event ->
            ...
            binding.tvTime.text = DateFormatter.formatDateTime(event.beginTime)
            binding.tvQuota.text = "Remaining Quota: ${(event.quota - event.registrants).toString()}"

            // Remove redundant and unrendered image
